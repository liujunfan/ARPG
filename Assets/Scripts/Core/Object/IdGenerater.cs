...
namespace Nono
{
    ...
    public class IdGenerater : Singleton<IdGenerater>
    {
        ...
        {
            uint a = (uint)((TimeInfo.Instance.FrameTime - epoch2020) / 1000);
            return a;
        }
        
        private uint TimeSinceThisYear()
        {
            uint a = (uint)((TimeInfo.Instance.FrameTime - epochThisYear) / 1000);
            return a;
        }
        ...
        public long GenerateInstanceId()
        {
            ...
            InstanceIdStruct instanceIdStruct = new InstanceIdStruct(lastInstanceIdTime, Options.Instance.Process, instanceIdValue);
        ...
        public long GenerateId()
        {
            ...
            IdStruct idStruct = new IdStruct(lastIdTime, Options.Instance.Process, value);
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            UnitIdStruct unitIdStruct = new UnitIdStruct(zone, Options.Instance.Process, lastUnitIdTime, unitIdValue);
