...
namespace Nono
{
    ...
    public struct RuntimeUtilities
    {
        ...
        public static float unitedDeltaTime
        {
            get
            {
                ...
                if (!Application.isPlaying)
                    return EditorUtilities.unscaledDeltaTime * Time.timeScale;
                else
#endif
...
#if UNITY_EDITOR
                if (!Application.isPlaying)
                    return EditorUtilities.unscaledDeltaTime;
                else
#endif
        ...
        public static UnityEngine.SceneManagement.Scene FindScene(Predicate<UnityEngine.SceneManagement.Scene> match)
        {
        ...
        public static int FindSceneIndex(Predicate<UnityEngine.SceneManagement.Scene> match)
        {
            for (int i = 0; i < SceneManager.sceneCount; i++)
            {
